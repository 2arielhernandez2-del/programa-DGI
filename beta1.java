	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1: {
				...
				if (sueldoNominal >= pisoPrimeraFranja && sueldoNominal <= techoPrimeraFranja) {
			...
			case 2: {
				...
				if (jubilacionPension >= pisoPrimeraFranjaIass && jubilacionPension <= techoPrimeraFranjaIass) {
				...
				if (jubilacionPension > techoPrimeraFranjaIass && jubilacionPension < pisoTerceraFranjaIass) {
					...
					System.out.println(terceraFranjaIASSCuenta + precioFranja3I * 0.24);

				} else if (jubilacionPension > techoTerceraFranjaIass) {

					System.out.println("debe pagar: ");

					System.out.println(cuartaFranjaIASSCuenta + precioFranja4I * 0.30);
			...
			case 4: {
				...
				System.out.println("==========================================================================");
				int credencial = lector.nextInt();
				System.out.println("==========================================================================");
				System.out.println("ingrese su domicilio (sin espacios)");
				System.out.println("==========================================================================");
				...
				System.out.println("su credencial es: " + credencial);
