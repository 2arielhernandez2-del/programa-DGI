...
public class proyectoDGI {
	...
	public static void main(String[] args) {
        ...
        double franja3I = terceraFranjaIASSCuenta;
        double franja4I = cuartaFranjaIASSCuenta + terceraFranjaIASSCuenta;
		...
		do {
			...
			case 1: {
				...
				if (sueldoNominal <= 0) {
					...
					System.out.println("su sueldo entra en la septima franja");
				...
				if (precioFranja1 < 0) {
					...
					System.out.println(precioFranja2 * 0.10);

				} else if (sueldoNominal > techoSegundaFranja && sueldoNominal < pisoCuartaFranja) {

					System.out.println("debe pagar:");

					System.out.println(terceraFranjaIRPF * 0.10 + precioFranja3 * 0.15);

				} else if (sueldoNominal > techoTerceraFranja && sueldoNominal < pisoQuintaFranja) {

					System.out.println("debe pagar: ");

					System.out.println(cuartaFranjaIRPF * 0.15 + terceraFranjaIRPF * 0.10 + precioFranja4 * 0.24);

				} else if (sueldoNominal > techoCuartaFranja && sueldoNominal < pisoSextaFranja) {

					System.out.println("debe pagar: ");

					System.out.println(quintaFranjaIRPF * 0.24 + cuartaFranjaIRPF * 0.15 + terceraFranjaIRPF * 0.10
					...
					System.out.println(sextaFranjaIRPF * 0.25 + quintaFranjaIRPF * 0.24 + cuartaFranjaIRPF * 0.15
					...
					System.out.println(septimaFranjaIRPF * 0.27 + sextaFranjaIRPF * 0.25 + quintaFranjaIRPF * 0.24
					...
					System.out.println(octavaFranjaIRPF * 0.31 + septimaFranjaIRPF * 0.27 + sextaFranjaIRPF * 0.25
			...
			case 3: {
				...
				int conyugeACargo = lector.nextInt();
				...
				if (sueldoNominalF <= 0) {
					...
					if (sueldoNominalF <= fonasaMin) {
						...
						if (conyugeACargo == 1 && menoresACargoFonasa == 0) {
							...
							System.out.println(
									"==========================================================================");
							System.out.println("debe pagar por el sueldo nominal: " + (sueldoNominalF * mas2Pago));
							System.out.println("su porcentaje aplicado es: " + mostrarPorcentaje + "%");

						} else if (conyugeACargo == 1 && menoresACargoFonasa >= 1) {
						...
						if (conyugeACargo == 0 && menoresACargoFonasa == 0) {
						...
						} else if (conyugeACargo == 0 && menoresACargoFonasa >= 1) {
				...
				if (aguinaldo <= 0) {
					...
					System.out.println("==========================================================================");
					System.out.println("No debe pagar FONASA por el aguinaldo");
					...
					if (aguinaldo <= fonasaMin) {
						...
						if (conyugeACargo == 1) {
							...
							System.out.println(
									"==========================================================================");
							System.out.println("debe pagar por el aguinaldo: " + (aguinaldo * hasta2Pago));
							System.out.println("su porcentaje aplicado es: " + mostrarPorcentaje + "%");
						...
						if (conyugeACargo == 1 && menoresACargoFonasa == 0) {
							...
							System.out.println(
									"==========================================================================");
							System.out.println("debe pagar por el aguinaldo: " + (aguinaldo * mas2Pago));
							System.out.println("su porcentaje aplicado es: " + mostrarPorcentaje + "%");
			...
			case 5: {
				...
				System.out.println("El programa pedira ingresar los datos nesesarios para calcular el impuesto");
				...
				System.out.println("el programa pedira ingresar los datos nesessarios para calcular el impuesto");
				System.out.println("luego el programa devolvera el resultado del impuesto");
				System.out.println(" ");
				System.out.println("==========================================================================");
				System.out.println(
